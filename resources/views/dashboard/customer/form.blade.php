<div class="row">
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" name="name" class="form-control" value="{{ old('name') }}" id="name" placeholder="ادخل اسم العميل">
        </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="mb-3">
            <label for="address" class="form-label">عنوان العميل</label>
            <input type="text" name="address" value="{{ old('address') }}" class="form-control" id="address" placeholder="ادخل عنوان العميل">
        </div>
