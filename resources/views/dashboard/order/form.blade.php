...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" name="ship" value="{{ old('ship') }}" class="form-control" id="ship" placeholder="ادخل سعر التوصيل">
        </div>
    ...
    <div class="row error"  >
        <div class="col-md-6 text-center" id="error_price" style="display: none">
                <div class="alert alert-danger " style="font-weight: bold" role="alert" id="price_error">
                </div>
            
        </div>
        <div class="col-md-6 text-center" id="error_ship" style="display: none">
                <div class="alert alert-danger " style="font-weight: bold" role="alert" id="ship_error">
                </div>
        </div>
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            <label for="phone2" class="form-label">رقم البوليصة</label>
            <input type="text" name="phone2" value="{{ old('phone2') }}" class="form-control" id="phone2" placeholder="ادخل رقم البوليصة">
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="mb-3">
                <label for="country" class="form-label" >محافظة المستلم</label>
                <input type="text" name="country" value="{{ old('country') }}" class="form-control" id="country" placeholder="ادخل محافظة المستلم">
            </div>
    ...
    <div class="row error" > 
        <div class="col-md-12 text-center" id="error_country" style="display: none">
                <div class="alert alert-danger " style="font-weight: bold" role="alert" id="country_error">
                </div>
        </div>
    </div>
